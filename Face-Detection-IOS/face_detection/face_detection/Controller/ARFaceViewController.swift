...
class ARFaceViewController: UIViewController, ARSCNViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.sceneView = ARSCNView(frame: CGRect(x: 0, y: 0, width: 375, height: 812))
        self.debugTextView = UITextView(frame: CGRect(x: 0, y: 30, width: 375, height: 65))
        ...
        let button = UIButton(frame: CGRect(x: 175, y: 395, width: 20, height: 20))
