...
open class LoginViewController: UIViewController, BackgroundMovable, KeyboardMovable {
    ...
    @objc var loginAttempted = false

    @objc var loginInProgress = false {
        didSet {
    ...
    @objc var selectedField: UITextField?

    @objc var offset: CGFloat = 0.0

    // MARK: Background Movable

    @objc var movableBackground: UIView { return backgroundImageView }
...
extension LoginViewController {
    ...
    @objc func validateFields(success: () -> Void) {
