...
public class Buttn: UIButton {
    ...
    @objc func resetLayerProperties() {
        layer.backgroundColor = buttnColor.cgColor
    ...
    @objc func drawBorder(_ context: CGContext?, rect: CGRect) {
        switch border {
        case .top:
    ...
    @objc func drawTopBorder(_ context: CGContext?, rect: CGRect) {
        context?.move(to: CGPoint(x: rect.minX, y: rect.minY))
        context?.addLine(to: CGPoint(x: rect.maxX, y: rect.minY))
    }

    @objc func drawBottomBorder(_ context: CGContext?, rect: CGRect) {
        context?.move(to: CGPoint(x: rect.minX, y: rect.maxY))
        context?.addLine(to: CGPoint(x: rect.maxX, y: rect.maxY))
    }

    @objc func drawLeftBorder(_ context: CGContext?, rect: CGRect) {
        context?.move(to: CGPoint(x: rect.minX, y: rect.minY))
        context?.addLine(to: CGPoint(x: rect.minX, y: rect.maxY))
    }

    @objc func drawRightBorder(_ context: CGContext?, rect: CGRect) {
